    ...
    <div className="space-y-3">
      ...
      <Accordion type="single" defaultValue="item-1" collapsible>
        ...
        <AccordionItem asChild value="item-1">
          <div>
            ...
            <AccordionContent>
              <div className={`text-[#DB4444] text-[18px] font-medium cursor-pointer ${selectedCategory === null ? "underline" : ""}`} onClick={() => handleCategoryChange(null)}>
                All Products
              </div>
            </AccordionContent>
            {category.map((e) => (
              <AccordionContent key={e.id}>
                <label className="flex items-center cursor-pointer gap-2">
                  <input type="radio" name="category" checked={selectedCategory === e.id} onChange={() => handleCategoryChange(e.id)} />
                  <span className="text-[#505050] text-[16px] font-medium">{e.categoryName}</span>
                </label>
              </AccordionContent>
            ))}
          </div>
      ...
      <Accordion type="single" defaultValue="item-1" collapsible>
        <AccordionItem asChild value="item-1">
          <div>
            ...
            <AccordionContent>
              <div className={`text-[#DB4444] text-[18px] font-medium cursor-pointer ${selectedBrand === null ? "underline" : ""}`} onClick={() => handleBrandChange(null)}>
                All Brands
              </div>
            </AccordionContent>
            ...
            {brand.map((e) => (
              <AccordionContent key={e.id}>
                <label className="flex gap-3 items-center cursor-pointer">
                  <input type="radio" name="brand" checked={selectedBrand === e.id} onChange={() => handleBrandChange(e.id)} />
                  <p className="text-[#505050] text-[16px] font-medium">{e.brandName}</p>
                </label>
              </AccordionContent>
            ))}
          </div>
          ...
          <div>
            ...
            <AccordionContent>
              <div className="flex gap-3 items-center">
                ...
                <p className="text-[#505050] text-[16px] font-medium">Metallitc</p>
              </div>
            </AccordionContent>
            ...
            <AccordionContent>
              <div className="flex gap-3 items-center">
                <input type="radio" name="features" />
                <p className="text-[#505050] text-[16px] font-medium">Plastic cover</p>
              </div>
            </AccordionContent>
            ...
            <AccordionContent>
              <div className="flex gap-3 items-center">
                <input type="radio" name="features" />
                <p className="text-[#505050] text-[16px] font-medium">8GB Ram</p>
              </div>
            </AccordionContent>
            ...
            <AccordionContent>
              <div className="flex gap-3 items-center">
                <input type="radio" name="features" />
                <p className="text-[#505050] text-[16px] font-medium">Super power</p>
              </div>
            </AccordionContent>
            ...
            <AccordionContent>
              <div className="flex gap-3 items-center">
                <input type="radio" name="features" />
                <p className="text-[#505050] text-[16px] font-medium">Large Memory</p>
              </div>
            </AccordionContent>
          </div>
        </AccordionItem>
      ...
      <div className="p-4 border-t border-gray-200">
        ...
        <div className="space-y-4">
          <button onClick={applyFilter} className="w-full border border-red-500 text-red-500 py-2 rounded-md text-sm font-medium hover:bg-red-50 transition">
            Apply
          </button>
          <button onClick={resetFilter} className="w-full border border-gray-400 text-gray-600 py-2 rounded-md text-sm font-medium hover:bg-gray-100 transition">
            Reset
          </button>
        </div>
      </div>
