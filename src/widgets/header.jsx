      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-6">
          {token ? (
            <>
              <div onClick={() => goTo("/wishlist")}>
                <div className="hidden md:block relative">
                  <div className="absolute bottom-3 left-3 w-6 h-6 flex items-center justify-center bg-[#DB4444] text-white text-[18px] rounded-full">{wishes.length}</div>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
              ...
              <div onClick={() => goTo("/cart")}>
                <div className="relative">
                  <div className="absolute bottom-3 left-3 w-6 h-6 flex items-center justify-center bg-[#DB4444] text-white text-[18px] rounded-full">{products}</div>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
            ...
            <Link to="/login" className="px-5 py-2 bg-[#DB4444] rounded-full text-white font-semibold hover:bg-[#c53636] transition">
              Log In
            </Link>
          )}
        </div>
